#!/usr/bin/env python3
"""
Homology Mapper Pipeline - Unified Entry Point (NEW/SIMPLE Algorithm)
...
from pipeline.executor_NEW import SimpleParaDISMExecutor
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Read-mapping and refinement workflow for highly homologous regions (supports both paired-end and single-end) - NEW/SIMPLE Algorithm",
