...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--full-dir", type=Path, default=Path("benchmark/giab/vcf_out_full"))
    parser.add_argument("--tenx-dir", type=Path, default=Path("benchmark/giab/vcf_out_10x"))
    parser.add_argument("--output", type=Path, default=Path("benchmark/giab/giab_full_10x_summary.svg"))
