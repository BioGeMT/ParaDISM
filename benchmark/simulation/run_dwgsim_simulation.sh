...
#  2) Run a PKD1/PKD1P* read simulation against benchmark/references/pkd1_panel.fa.
#
# You can override key parameters via environment variables:
#   REF        : reference FASTA (default: benchmark/references/pkd1_panel.fa)
#   OUT_DIR    : output directory for DWGSIM files (default: results/simulation/pkd_reads_dwgsim)
...
# Example:
#   cd ParaDISM
#   bash benchmark/simulation/run_dwgsim_simulation.sh
#
...
REF="${REF:-${PROJECT_ROOT}/benchmark/references/pkd1_panel.fa}"
OUT_DIR="${OUT_DIR:-${PROJECT_ROOT}/results/simulation/pkd_reads_dwgsim}"
OUT_PREFIX="${OUT_PREFIX:-${OUT_DIR}/pkd_reads_dwgsim}"
DWGSIM_DIR="${DWGSIM_DIR:-${PROJECT_ROOT}/results/simulation/dwgsim}"
