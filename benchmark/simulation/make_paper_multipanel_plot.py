...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--figure1-data-dir",
        type=Path,
        default=Path("results/simulation/pkd1_panel/figure1_data"),
        help="Directory containing panel_A_all_aligners.csv and panel_B_all_aligners.csv",
    )
    parser.add_argument(
        "--iteration-plots-dir",
        type=Path,
        default=Path("results/simulation/pkd1_panel/iteration_plots"),
        help="Directory containing iteration_progression_<aligner>.csv files",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("results/simulation/pkd1_panel/figure1_data/paper_multipanel_figure.svg"),
